...
def main(args):
    ...
    yhat_test, score = model_evaluation(
        X_test, y_test, model, args.evaluation_output)
...
def model_evaluation(X_test, y_test, model, evaluation_output):
    ...
    # Save the output data with feature columns, predicted cost, and actual
    # cost in csv file
...
def model_promotion(
    ...
    perf_comparison_plot.figure.savefig(
        Path(evaluation_output) / "perf_comparison.png")
